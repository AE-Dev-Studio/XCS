  ...
  return (
    <Card className="flex flex-col h-full hover:shadow-xl transition-all duration-300 border-none rounded-none bg-[#1f1f1f] overflow-hidden">
      ...
      <div className="flex flex-col flex-1 justify-between p-4 md:p-6 gap-3">
        <div>
          <h3 className="font-semibold text-lg text-white mb-2 hover:text-[#a89447]">
            {title}
          </h3>
        ...
        {/* View Service Button */}
        <p className="text-white text-sm mt-4 pointer-events-auto cursor-pointer hover:text-[#a89447] transition-colors">
          View Service →
        </p>
      </div>
    </Card>
