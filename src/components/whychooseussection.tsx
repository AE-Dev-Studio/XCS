            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-black  max-w-4xl mx-auto">
                        Renowned for exceptional quality and professionalism, Xclusive Chauffeurs is your go-to company for premium chauffeur hire in Manchester and London. Our hallmarks include the following:
                    </p>
                </div>
