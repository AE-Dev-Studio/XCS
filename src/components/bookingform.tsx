...
export default function BookingForm() {
    ...
    return (
        <div className="rounded-lg bg-white backdrop-blur-sm p-8 shadow-2xl">
            {submitted ? (
                <div className="space-y-4 text-center py-8">
                    <div className="text-4xl">✓</div>
                    <h3 className="text-xl font-semibold text-gray-900">Booking Request Received</h3>
                    <p className="text-gray-600">Thank you! We'll contact you shortly to confirm your booking.</p>
                </div>
            ) : (
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="flex flex-row gap-2 ">
                        <Image
                            src="/assets/logo.jpg"
                            alt="App Logo"
                            className="w-20 h-20 mb-3 text-center"
                            height={80}
                            width={80}
                        />
                        <p className="text-3xl font-bold font-sans text-black uppercase tracking-wide mb-4 text-center mt-5">Booking Details</p>
                    </div>
              ...
              Vehicle Requested <span className="text-red-500">*</span>
                            ...
                            <Select value={formData.vehicle} onValueChange={handleSelectChange}>
                                <SelectTrigger
                                    id="vehicle"
                                    className={`${errors.vehicle ? "border-red-500 focus-visible:ring-red-500" : ""}`}
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="rolls-royce-chullain">Rolls Royce Chullain</SelectItem>
                                    <SelectItem value="rolls-royce-phantom">Rolls Royce Phantom</SelectItem>
                                    <SelectItem value="rolls-royce-mybech">Rolls Royce Mybech</SelectItem>
              ...
              Pick Up <span className="text-red-500">*</span>
                            ...
                            <Input
                                ...
                                onChange={handleInputChange}
                                className={`${errors.pickUp ? "border-red-500 focus-visible:ring-red-500" : ""}`}
