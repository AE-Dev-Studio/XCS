...
export default function QuoteForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const endpoint =
      tab === "self" ? "/api/quote/self" : "/api/quote/driver";
    ...
    <section className="mx-auto max-w-3xl rounded-lg bg-black p-6 my-5 shadow-lg z-10">
      ...
      {tab === "self" && (
        ...
        >
          ...
          <Input type="date" name="dateFrom" placeholder="Date From *" required />
          <Input type="date" name="dateTo" placeholder="Date To *" required />
          <TextArea
            name="message"
            placeholder="Other Information"
      ...
      {tab === "driver" && (
        ...
        >
          ...
          <Input type="time" name="pickupTime" placeholder="Pickup Time *" required />
          <Input name="pickupAddress" placeholder="Pickup Address *" required />
          ...
          <Input type="time" name="dropoffTime" placeholder="Drop-off Time *" required />
          <Input name="occasion" placeholder="Occasion" className="md:col-span-2" />
          <TextArea
            name="message"
            placeholder="Other Information"
            className="md:col-span-2"
