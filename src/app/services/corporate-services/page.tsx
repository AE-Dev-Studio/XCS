...
const Page = () => {
    return (
        <>
            ...
            <TextImageSection heading='Corporate Car Hire Excellence in London' paragraph='Extend your corporate experience to the cosmopolitan heart of London with our corporate car hire services. Seamlessly blending style and functionality, our chauffeur service ensures you arrive at your destination in absolute comfort and sophistication. Trust us to provide corporate car service that aligns with London’s dynamic and fast-paced business environment. Elevate your corporate travel experience with our premium car rental solutions, setting the benchmark for excellence in Manchester and London.' image='/assets/aboutimage.jpg' />
            <MetricsBanner />
            <Samecomponent />
        </>
    )
