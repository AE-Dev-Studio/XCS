...
const Page = () => {
  return (
    <>
      <Herobg text='Airport Chauffeur Manchester' image='/assets/airporthero.jpg' />
      <Sendmessagesection heading='Exquisite Journeys with CCS Chauffeurs: Seamless Luxury Airport Transfers' paragraph='Experience travel at its finest with CCS clusiveChauffeurs, your trusted partner for exclusive luxury airport transfer services that epitomize sophistication and unrivaled comfort. We specialize in opulent Manchester airport transfers and ensure a seamless flight from your flight to your desired destination.' />
      <Resusablefleet />
      <Getaqoutesection heading='Elevated Excellence in Executive Airport Transfers' paragraph='Uncover the pinnacle of service with CCS Chauffeurs’ executive airport transfers, meticulously designed for the most discerning travelers. Our commitment to excellence permeates every detail, promising an indulgent experience for business and leisure trips. Immerse yourself in the epitome of comfort and style as we redefine the standards of airport transfers in Manchester.' />
      ...
      <TextImageSection heading='Cosmopolitan Luxury Beyond Manchester: Private Airport Transfers with CCS Chauffeurs'  paragraph='Embrace the cosmopolitan allure with CCS Chauffeurs as our private airport transfer services extend beyond Manchester, providing an equally luxurious experience in London. From the moment you land at the airport, our chauffeurs ensure a prompt and polished service, reflecting our dedication to providing an unforgettable journey. Redefine your travel experience with CCS Chauffeurs’ exclusive airport transfer solutions, seamlessly merging luxury with convenience.' image='/assets/airporthero.jpg'/>
      <MetricsBanner/>
      <Samecomponent />
    </>
  )
