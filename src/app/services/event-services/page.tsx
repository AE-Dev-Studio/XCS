...
const Page = () => {
    return (
        <>
            ...
            <Sendmessagesection heading='Premier Event Transport Services in Manchester and London' paragraph='Elevate your event with our exceptional event transport services, seamlessly blending luxury, reliability, and style. As your go-to provider in Manchester and London, we specialize in crafting unforgettable transportation experiences for various occasions' />
            <Resusablefleet />
            <Getaqoutesection heading='Exquisite Event Chauffeur Services in Manchester' paragraph='Experience the epitome of elegance with our event chauffeur services in Manchester. Whether it is a corporate function or a special celebration, our professional chauffeurs ensure a sophisticated and seamless journey. From precise logistics to luxurious vehicles, we take pride in delivering unparalleled service, making your event transportation a highlight of the occasion.' />
            ...
            <TextImageSection heading='Hire Event Car - Tailored Luxury Transportation' paragraph='When you hire an event car with us, you choose a bespoke transportation solution tailored to your event’s unique needs. Our diverse fleet caters to various preferences, ensuring the perfect vehicle for every occasion. Trust us to enhance your event with our premium hire event car services, delivering an unparalleled blend of style and substance in Manchester and London.' image='/assets/weddingeventcar.jpg' />
            <MetricsBanner />
            <Samecomponent />
        </>
    )
