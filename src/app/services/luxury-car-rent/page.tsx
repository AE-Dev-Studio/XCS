...
const Page = () => {
  return (
    <>
      ...
      <TextImageSection heading='CCS Chauffeurs: Manchester Luxury Car Rentals for Special Occasions'  paragraph='Book your exclusive ride with Xclusive Chauffeurs Services today and travel in style, class, and ultimate luxury. Let us make your special events or business trips memorable with our luxury car rental services in Manchester.' image='/assets/carinner.jpeg'/>
      <MetricsBanner/>
      <Samecomponent />
    </>
  )
